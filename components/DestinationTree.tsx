...
//   // Build SVG connection paths connecting selected parent to its children in next column
//   // Use double requestAnimationFrame and observers so the very first click measures after layout/images
//   useLayoutEffect(() => {
//     let raf1 = 0;
//     let raf2 = 0;
...
//     // Defer measurement to next 2 frames to ensure layout/offsets/images are applied on first click
//     raf1 = requestAnimationFrame(() => {
//       raf2 = requestAnimationFrame(measure);
//     });

//     // Recalculate when images load or container resizes (helps the first paint)
...
//       const fn = () => measure();
//       if (!img.complete) {
//         img.addEventListener('load', fn, { once: true } as any);
...
//     };
//   }, [columns, activePath, columnOffsets]);

//   useEffect(() => {
//     const onResize = () => setPaths((p) => p.slice());
