...
export default function AgencyForm({ agency }: AgencyFormProps) {
  ...
  return (
    <div className="card p-6" style={{ borderColor: agency.primary_color }}>
      ...
      <div className="mb-6 text-center">
        ...
        <div className="mb-2 text-sm text-gray-600" style={{ color: agency.secondary_color }}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {routePreference === 'trip-design' ? (
          <div className="space-y-6">
              ...
              <div className="mt-4 rounded-md bg-gray-50 p-4">
                <label className="flex items-center gap-2 text-sm font-semibold text-gray-800">
                  <input
                    ...
                    style={{
                      accentColor: agency.primary_color,
                    }}
                  />
            ...
            <div>
              ...
              />
              {golfTrip === 'yes' ? (
                <div className="mt-4 rounded-md border-l-4 bg-sky-50 p-4" style={{ borderColor: agency.secondary_color }}>
        ...
        <div className="pt-4">
          <button
            ...
            disabled={!canSubmit}
            style={{
              backgroundColor: canSubmit ? agency.primary_color : undefined,
              borderColor: canSubmit ? agency.primary_color : undefined,
            }}
          >
            Continue
          </button>
